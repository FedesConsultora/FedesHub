...
export const scopeEnum = z.enum(['mine', 'feder', 'cliente', 'global', 'all']);
...
export const listCalendarsQuery = z.object({
  ...
  return true;
}, { message: 'falta feder_id/cliente_id según scope' });

export const upsertCalendarSchema = z.object({
  id: z.number().int().optional(),
  tipo_codigo: z.enum(['personal', 'cliente', 'global']),
...
export const listEventsQuery = z.object({
  ...
  return true;
}, { message: 'falta feder_id/cliente_id o calendario_ids según scope' });
