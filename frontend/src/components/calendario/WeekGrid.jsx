                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          height: Math.max(22, (endMin - startMin) * MINUTE_PX),
                          left: leftCss,
                          width: widthCss,
                          borderLeftColor: ev.color || '#3b82f6',
                          backgroundColor: `${ev.color || '#3b82f6'}55`, // Even more vibrant but translucent
                          zIndex: (ev._lane || 0) + 10, // Higher base zIndex
